...
const origins = new Set(['https://graph.instagram.com', 'https://graph.threads.com', 'https://open.tiktokapis.com', 'https://api.vk.com', 'https://id.vk.ru', 'https://www.googleapis.com']);
