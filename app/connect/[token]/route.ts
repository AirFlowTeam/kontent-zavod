...
export async function GET(_request: Request, context: Context) {
  try {
    ...
    const oauth = ['Instagram', 'TikTok', 'VK'].includes(ticket.platformName);
